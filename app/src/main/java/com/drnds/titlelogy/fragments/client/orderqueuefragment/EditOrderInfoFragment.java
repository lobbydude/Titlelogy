...
public class EditOrderInfoFragment extends Fragment {
    ...
    private static String TAG = EditOrderInfoFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        pref  = getActivity().getSharedPreferences(ORDERPREFS_NAME, Context.MODE_PRIVATE);
        inputLayoutborrowername = (TextInputLayout) view.findViewById(R.id.input_layout_editborrowername);
        inputLayoutapn = (TextInputLayout) view.findViewById(R.id.input_layout_editapn);
        inputLayoutordernum = (TextInputLayout) view.findViewById(R.id.input_layout_editordernumber);
        inputOrdernum = (EditText) view.findViewById(R.id.input_editordernumber);
        inputCity = (EditText) view.findViewById(R.id.input_editcity);
        inputZip = (EditText) view.findViewById(R.id.input_editzip);
        inputAddress = (EditText) view.findViewById(R.id.input_editaddress);
        inputBorrowername = (EditText) view.findViewById(R.id.input_editborrowername);
        inputApn = (EditText) view.findViewById(R.id.input_editapn);
        inputDate = (EditText) view.findViewById(R.id.input_editdate);
        spinner1 = (Spinner) view.findViewById(R.id.customer_editspinner);
        spinner2 = (Spinner) view.findViewById(R.id.product_editspinner);
        spinner3 = (Spinner) view.findViewById(R.id.state_editspinner);
        spinner4 = (Spinner) view.findViewById(R.id.county_editspinner);
        spinner5 = (Spinner) view.findViewById(R.id.ordertask_editspinner);
        spinner6 = (Spinner) view.findViewById(R.id.status_editspinner);
        spinner7 = (Spinner) view.findViewById(R.id.orderpriority_editspinner);
        spinner8 = (Spinner) view.findViewById(R.id.countytype_editspinner);
        ...
        submit=(Button)view.findViewById(R.id.button_editordersubmit);
...
//        countytype
    ...
    public void  getOrderdetails() {
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET, Config.ORDERDETAILS_URL +Order_Id, null, new Response.Listener<JSONObject>() {
