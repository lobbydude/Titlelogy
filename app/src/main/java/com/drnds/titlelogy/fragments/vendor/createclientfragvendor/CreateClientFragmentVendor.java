package com.drnds.titlelogy.fragments.vendor.createclientfragvendor;
...
public class CreateClientFragmentVendor extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
...
//                        vendorclient.setSubId(details.getString("Sub_Client_Id"));
                        ...
                        mAdapter = new VendorClientAdapter(vendorclientArrayList);
