...
import com.drnds.titlelogy.activity.client.PiechartActivity;
...
//        chart.setTouchEnabled(false);
        ...
        button = (Button)view.findViewById(R.id.vendorpiechart);
    ...
    public void getPiechart(){
        StringRequest stringRequest=new StringRequest(Request.Method.GET, Config.VENDORDASHBOARD_URL+getVendorId(), new Response.Listener<String>() {
            ...
            public void onResponse(String response)
            {
                ...
                barDataSet1.setColors(com.drnds.titlelogy.util.ColorTemplate.MATERIAL_COLORS);
//                barDataSet1.setColor(Color.WHITE);
                xAxis1.add("NewOrders");
                xAxis1.add("SearchOrders");
                xAxis1.add("SearchQc");
                xAxis1.add("TypingOrders");
                xAxis1.add("TypingQc");
                xAxis1.add("FinalReview");
                xAxis1.add("TaxOrders");
                xAxis1.add("Completed");
