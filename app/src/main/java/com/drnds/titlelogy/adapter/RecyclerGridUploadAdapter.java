...
public class RecyclerGridUploadAdapter extends RecyclerView.Adapter< RecyclerGridUploadAdapter.MyViewHolder>   {
    private List<GridUpload> uploadList;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private List<GridUpload> uploadList=new ArrayList<GridUpload>();
        Context ctx;

        public MyViewHolder(View view, final Context ctx, final List<GridUpload>  uploadList) {
            super(view);
    ...
    public RecyclerGridUploadAdapter(List<GridUpload>uploadList,Context context) {
        this. uploadList=   uploadList;
    ...
    public RecyclerGridUploadAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new RecyclerGridUploadAdapter.MyViewHolder(itemView,ctx,uploadList);
    }

    @Override
    public void onBindViewHolder(RecyclerGridUploadAdapter.MyViewHolder holder, int position) {
        GridUpload upload = uploadList.get(position);
    ...
    private long DownloadData (Uri uri, View v) {
        ...
        if(v.getId() == R.id.img_griddocdownload)
