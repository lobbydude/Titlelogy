...
public class VendorRecyclerUploadAdapter extends RecyclerView.Adapter< VendorRecyclerUploadAdapter.MyViewHolder>  {
    ...
    VendorRecyclerUploadAdapter madapter;
    String subid;
...
//                    Uri file_uri = Uri.parse("http://maven.apache.org/archives/maven-1.x/maven.pdf");
    ...
    public VendorRecyclerUploadAdapter(List<Upload>uploadList,Context context) {
        this. uploadList=   uploadList;
    ...
    @Override
    public VendorRecyclerUploadAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.upload_row, parent, false);

        return new VendorRecyclerUploadAdapter.MyViewHolder(itemView,ctx,uploadList);
    }

    @Override
    public void onBindViewHolder(VendorRecyclerUploadAdapter.MyViewHolder holder, int position) {
